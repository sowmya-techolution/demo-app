...
public class TelcoPrepaidInquiryNew {
...
//        GenericPackager p = new GenericPackager("/Users/gtidevelopment/Desktop/server-edc-npg/packager/iso87ascii-edc.xml");

//        NACChannel ch = new NACChannel("10.100.111.194",1300, p, null);
//        NACChannel ch = new NACChannel("10.32.3.7",1700, p, null);
//        ch.setHeader("0000000000".getBytes());

        GenericPackager p = new GenericPackager("/Users/gtidevelopment/Project/billerdkilink-router/src/main/java/co/id/bankdki/billerdkilinkrouter/iso/packager/iso87ascii.xml");
        NACChannel nacChannel = new NACChannel("10.100.111.152", 13001, p, null);
        nacChannel.connect();
        nacChannel.setHeader("0000000000");
...
//        m.set(98,"100005"); // SMARTFREN PREPAID
        ...
        nacChannel.setLogger(logger, "channel");

        nacChannel.connect();
        nacChannel.send(m);

        ISOMsg r = nacChannel.receive();
