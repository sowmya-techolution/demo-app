package co.id.bankdki.billerdkilinkrouter.iso.unpam;

import co.id.bankdki.billerdkilinkrouter.BillerdkilinkRouterApplication;
import co.id.bankdki.billerdkilinkrouter.utils.FinnetRCTextParser;
...

  {
      ...
      public void commit(long l, Serializable serializable) {
          ...
          try {
              ...
              b.set(4,ISOUtil.zeropad(m.getString(4), 12));
              b.set(7,m.getString(7));
              b.set(11,ISOUtil.zeropad(m.getString(11), 6));
              ...
              if(resp != null){
                  ...
                  switch (resp.getString(39)) {
                    ...
                    //kebutuhan data untuk reporting Jasper
                    resp48.append(resp.getString(48)); //KODE PEMBAYARAN
                    resp48.append("|");
                    resp48.append ((Long.valueOf(resp.getString(4)+(resp.getString(63))))); //TOTAL BAYAR
                    resp48.append("|");
                    resp48.append(m.getString(107)); //REKENING NASABAH

                        break;

                default:
                    m.set(61, FinnetRCTextParser.parse(resp.getString(39), ""));
                    break;

            }
                  m.set(39,resp.getString(39));
                  m.set(48, resp48.toString());
