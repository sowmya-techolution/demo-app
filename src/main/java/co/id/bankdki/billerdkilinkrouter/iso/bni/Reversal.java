...

 {
     ...
     public void commit(long l, Serializable serializable) {
         ...
         try {
             ...
             f.set(4,ISOUtil.zeropad(m.getString(4), 12));
             f.set(7,m.getString(7));
             f.set(11,ISOUtil.zeropad(m.getString(11), 6));
             f.set(13,m.getString(13));
             f.set(15,m.getString(15));
             f.set(27,m.getString(27));
             f.set(32,m.getString(32));
             f.set(37,ISOUtil.zeropad(m.getString(37), 12));
             f.set(38,ISOUtil.zeropad(m.getString(38), 6));
             f.set(43,m.getString(43));
             f.set(49,m.getString(49));
             f.set(59,m.getString(59));
             f.set(60,m.getString(60));
             f.set(90,m.getString(90).substring(0,10)+ m.getString(90).substring(22,54));
