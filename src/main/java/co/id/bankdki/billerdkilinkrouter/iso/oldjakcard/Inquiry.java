package co.id.bankdki.billerdkilinkrouter.iso.oldjakcard;
...
//             b.set(61,m.getString(48));
             b.set(61,m.getString(48).substring(2, m.getString(48).length()));
